...
@Slf4j
public class EventDataSchema implements KafkaDeserializationSchema<ConsumerRecord<byte[], byte[]>>, KafkaSerializationSchema<JsonNode> {
    ...
    public EventDataSchema(ParameterTool parameterTool, String topic) {
